...
class DemandShortSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Demand
        fields = ('url','id','title', 'requester','is_CAPS','is_BARTER','is_GIVE','price_CAPS', 'created','updated', )
...
class ProjectVolunteersRegistrationSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def create(self, validated_data):
        ...
        registration = Project_Volunteers_Registration.objects.create(project_volunteers=project_volunteers, **validated_data)
...
class ProjectVolunteersSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields=('url','id','project','role','description','seats','registered','minimum_registration','volunteers_registration')
...
class ProjectAttendeesRegistrationSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def create(self, validated_data):
        ...
        registration = Project_Attendees_Registration.objects.create(project_attendees=project_attendees, **validated_data)
...
class ProjectDiscussionSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields=('url','id','project','project_ref','title','text','profile','created','updated','answer_discussion_project')
...
class ProjectSerializer(serializers.HyperlinkedModelSerializer):
    ...
    discussion_project = serializers.HyperlinkedRelatedField(many=True, view_name='project_discussion-detail', read_only=True)
    class Meta:
        model = Project
        fields = ('url','id','name', 'start','end','description','category','sub_category','number', 'street', 'postal_code', 'city', 'organizer', 'created', 'updated','project_type','attendees', 'volunteers','discussion_project'  )
